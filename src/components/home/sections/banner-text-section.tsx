...
export const BannerTextSection = () => {
    ...
    return (
        <>
            <div className="absolute z-10 top-[30%] sm:top-[35%]">
            ...
            <div className="absolute text-white bottom-[10%] left-1/2 transform -translate-x-1/2 z-10 sm:right-[5%] sm:left-auto sm:transform-none sm:flex sm:items-center">
                <span className="border rounded-full p-2 m-2">GH</span>
                <span className="border rounded-full p-2 m-2">LI</span>
                <span className="border rounded-full p-2 m-2">FB</span>
            </div>
