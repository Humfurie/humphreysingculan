...
export default function Footer() {
    return (
        <>
            <footer className="relative primary-container inset-x-0 bottom-0 h-16">
                <div className="mx-auto w-full max-w-screen p-4 py-6 lg:py-8">
                    <div className="md:grid md:grid-cols-5">
                        ...
                        <div className="justify-start col-span-3 p-4">
                            ...
                            <p>&emsp;I'm passionate about becoming a full-stack developer with a strong interest in server-side technologies. I'm enthusiastic about learning and always eager to expand my knowledge in this field. I believe in continuous improvement and enjoy tackling challenges to enhance my skills. </p>
                        </div>
                        <div className="grid gap-8 col-span-1 sm:gap-6 p-4">
                            <div>
