...
export default function Footer() {
    return (
        <>
            <footer className="relative inset-x-0 bottom-0 h-16">
                <div className="mx-auto w-full max-w-screen p-4 py-6 lg:py-8">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                ...
                                <ul className="text-gray-500 font-medium">
                                    <li className="mb-4">
                                        <Link href="#" className="hover:underline">Humfurie</Link>
                                    </li>
                                    <li>
                            ...
                            <div>
                                ...
                                <ul className="text-gray-500 font-medium">
                                    <li className="mb-4">
                                        <Link href="https://github.com/themesberg/Humfurie"
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                      <span className="text-sm text-orange-600 sm:text-center ">© 2024 <a
                          href="#" className="hover:underline">Humfurie™</a>. All Rights Reserved.
                      </span>
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            <Link href="#" className="text-gray-500 hover:text-gray-900">
                                <svg className="w-4 h-4 tech" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <Link href="#" className="text-gray-500 hover:text-gray-900 ms-5">
                                <FaLinkedin className="w-5 h-5 tech"/>
                                <span className="sr-only">GitHub account</span>
                            </Link>
                        </div>
                    </div>
